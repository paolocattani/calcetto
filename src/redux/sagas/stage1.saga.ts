...
function* fetchSaga({
	...
	yield* entityLifeCycle<FetchStage1Request, FetchStage1Response, Stage1Error>(
...
function* updatePlacementSaga({
	...
	yield* entityLifeCycle<UpdatePlacementRequest, UpdatePlacementResponse, Stage1Error>(
		Stage1Action.updatePlacement,
		updatePlacement,
		payload,
		undefined,
		undefined,
...
function* updateSelectedPairsSaga({
	...
	yield* entityLifeCycle<SelectPairsRequest, SelectPairsResponse, Stage1Error>(
